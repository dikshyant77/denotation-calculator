...
label1= Label(root,text="Hey user! Welcome to Denomination counter applicaton ", bg="light blue")
...
def topwin():
    ...
    entry = Entry(top)
    lbl = Label(top, text="Here are number of notes for each denominaton ", bg="light grey")
